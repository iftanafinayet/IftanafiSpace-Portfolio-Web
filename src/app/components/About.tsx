  ...
  return (
    <section id="about" className="max-w-[1440px] mx-auto px-8 lg:px-24 py-section-gap">
      ...
      <section className="mb-section-gap">
        <h2 className="text-3xl md:text-4xl font-bold text-black mb-12">Core Philosophy</h2>
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter h-auto md:h-[500px]">
          <div className="md:col-span-8 glass-card p-gutter rounded-2xl flex flex-col justify-end relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <h3 className="font-headline-md text-black mb-4">Scalable Architecture</h3>
              <p className="text-black max-w-lg font-body-md">Every line of code serves a purpose. I build robust systems that don't just look premium but are engineered for high-performance delivery and long-term stability.</p>
            </div>
          ...
          <div className="md:col-span-4 glass-card p-gutter rounded-2xl flex flex-col items-center justify-center text-center border-primary/20">
            ...
            <h3 className="font-headline-md text-black mb-2">User Experience (UX)</h3>
            <p className="text-black font-body-md">Technology should be invisible. I focus on intuitive interfaces that bridge the gap between complex logic and effortless user interaction.</p>
          </div>
          <div className="md:col-span-4 glass-card p-gutter rounded-2xl flex flex-col justify-between">
            <div className="w-12 h-12 rounded-lg bg-black/5 flex items-center justify-center border border-black/10">
              <span className="material-symbols-outlined text-black">account_tree</span>
            </div>
            <div>
              <h3 className="font-headline-md text-black mb-2">System Logic</h3>
              <p className="text-black text-sm">Architecture decisions backed by structural efficiency and optimized data flows.</p>
            </div>
          </div>
          <div className="md:col-span-8 glass-card p-gutter rounded-2xl flex items-center gap-gutter overflow-hidden group">
            <div className="flex-1">
              <h3 className="font-headline-md text-black mb-2">Continuous Deployment</h3>
              <p className="text-black">Deployment is just the beginning. I believe in refining systems through constant testing and real-world feedback loops.</p>
            </div>
            <div className="w-1/3 h-full rounded-xl bg-surface-container relative overflow-hidden">
              <img
                ...
                className="w-full h-full object-cover opacity-30 group-hover:opacity-60 transition-opacity filter grayscale"
              />
            </div>
          </div>
        </div>
