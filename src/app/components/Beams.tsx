      ...
      extendMaterial(THREE.MeshStandardMaterial, {
        ...
        vertexHeader: `
          ...
          vec3 getNormal(vec3 pos) {
            vec3 curpos = getCurrentPos(pos); vec3 nextposX = getCurrentPos(pos + vec3(0.01, 0.0, 0.0)); vec3 nextposZ = getCurrentPos(pos + vec3(0.0, -0.01, 0.0));
            vec3 tangentX = normalize(nextposX - curpos); vec3 tangentZ = normalize(nextposZ - curpos); return normalize(cross(tangentZ, tangentX));
          }`,
        vertex: {
...
const PlaneNoise = ({ material, width, count, height }: MergedPlanesProps) => (
  <MergedPlanes material={material} width={width} count={count} height={height} />
);
